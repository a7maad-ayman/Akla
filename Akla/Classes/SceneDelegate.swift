...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func createTabBar() -> UITabBarController {
        ...
        let homeNC = createNavigationController(viewController: HomeViewController(),
                                                title: "Home",
    ...
    func createNavigationController(viewController:
                                    UIViewController,
                                    title: String,
                                    tabBarItem:
                                    UITabBarItem) -> UINavigationController {
